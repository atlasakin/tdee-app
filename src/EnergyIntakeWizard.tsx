      ...
      return (
        <div className="py-8">
          ...
          <section className="mb-12 text-center p-8 rounded-lg border" style={{ borderColor: PALETTE.ACCENT, background: PALETTE.CARD_BACKGROUND }}>
            ...
            <a href="https://forms.gle/KWWXkffAHDuXZJmA8" target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-8 py-3 text-lg bg-[#c2a57a] hover:bg-[#d1b891] text-[#003153] font-bold rounded-lg shadow-md">
